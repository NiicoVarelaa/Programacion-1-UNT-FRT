...
public class EjercicioD6 {
    public static void main(String[] args) {
        ...
        if (numIngresadoTexto.length() > 3  && numIngresadoTexto.length() < 5) {
            ...
            if (esPrimo == 1) {
                System.out.println("El Numero Ingresado Cifrado es: " + numCifrado + " y No es Primo");
            } else {
...
/* Se ingresa un numero entero de 4 digitos y se desea cifrarlo para mas seguridad:
    Reemplazar cada digito por la suma del digito mas 9, mod 10. 
    Una vez cifrado verificar si es primo, si es primo descifrarlo y mostrar el original. */
